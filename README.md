...
- **Home/Upload**: User can upload up to 5 task files (supports image only for now), each file capped at a maximum size of 50 MB. Once the files are uploaded, the user can hit the "Optimize" button, which will query a chat prompt to openai/gpt-oss-120b model through LangChain and Groq API.
...
Following images show a high-level overview of the current version of OptLoad (user authentication, signed in home, upload feature, and results feature):
...
<p align="center">
    <img src="./public/upload.png" width={500}>
</p>

<p align="center">
    <img src="./public/results.png" width={500}>
</p>
